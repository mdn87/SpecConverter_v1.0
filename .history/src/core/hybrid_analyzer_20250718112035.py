...
class HybridAnalyzer:
    ...
    def _extract_numbering_patterns(self, template_analysis: TemplateAnalysis) -> List[Dict[str, Any]]:
        ...
        for num_id, num_def in template_analysis.numbering_definitions.items():
            for level in num_def.get('levels', []):
                pattern = {
                    'num_id': num_id,
